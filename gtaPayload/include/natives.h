...
namespace PLAYER
{
	...
	static Vect3 GET_PLAYER_WANTED_CENTRE_POSITION(Player player) { return invoke<Vect3>(0x0C92BA89F1AF26F8, player); } // 0x0C92BA89F1AF26F8 0x821F2D2C
...
namespace ENTITY
{
	...
	static Vect3 GET_COLLISION_NORMAL_OF_LAST_HIT_FOR_ENTITY(Entity entity) { return invoke<Vect3>(0xE465D4AB7CA6AE72, entity); } // 0xE465D4AB7CA6AE72 0xAB415C07
	...
	extern Vect3 GET_ENTITY_COORDS(Entity entity, BOOL alive) { return invoke<Vect3>(0x3FEF770D40960D5A, entity, alive); } // 0x3FEF770D40960D5A 0x1647F1CB
	static Vect3 GET_ENTITY_FORWARD_VECTOR(Entity entity) { return invoke<Vect3>(0x0A794A5A57F8DF91, entity); } // 0x0A794A5A57F8DF91 0x84DCECBF
	...
	static void GET_ENTITY_MATRIX(Entity entity, Vect3* rightVector, Vect3* forwardVector, Vect3* upVector, Vect3* position) { invoke<Void>(0xECB2FC7235A7D137, entity, rightVector, forwardVector, upVector, position); } // 0xECB2FC7235A7D137 0xEB9EB001
	static Hash GET_ENTITY_MODEL(Entity entity) { return invoke<Hash>(0x9F47B058362C84B5, entity); } // 0x9F47B058362C84B5 0xDAFCB3EC
	static Vect3 GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(Entity entity, float posX, float posY, float posZ) { return invoke<Vect3>(0x2274BC1C4885E333, entity, posX, posY, posZ); } // 0x2274BC1C4885E333 0x6477EC9E
	static Vect3 GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Entity entity, float offsetX, float offsetY, float offsetZ) { return invoke<Vect3>(0x1899F328B0E12848, entity, offsetX, offsetY, offsetZ); } // 0x1899F328B0E12848 0xABCF043A
	...
	static Vect3 GET_ENTITY_ROTATION(Entity entity, int rotationOrder) { return invoke<Vect3>(0xAFBD61CC738D9EB9, entity, rotationOrder); } // 0xAFBD61CC738D9EB9 0x8FF45B04
	static Vect3 GET_ENTITY_ROTATION_VELOCITY(Entity entity) { return invoke<Vect3>(0x213B91045D09B983, entity); } // 0x213B91045D09B983 0x9BF8A73F
	...
	static Vect3 GET_ENTITY_SPEED_VECTOR(Entity entity, BOOL relative) { return invoke<Vect3>(0x9A8D700A51CB7B0D, entity, relative); } // 0x9A8D700A51CB7B0D 0x3ED2B997
	...
	static Vect3 GET_ENTITY_VELOCITY(Entity entity) { return invoke<Vect3>(0x4805D2B1D8CF94A9, entity); } // 0x4805D2B1D8CF94A9 0xC14C9B6B
	...
	static Vect3 GET_WORLD_POSITION_OF_ENTITY_BONE(Entity entity, int boneIndex) { return invoke<Vect3>(0x44A8FCB8ED227738, entity, boneIndex); } // 0x44A8FCB8ED227738 0x7C6339DF
...
namespace PED
{
	...
	static Vect3 GET_DEAD_PED_PICKUP_COORDS(Ped ped, float p1, float p2) { return invoke<Vect3>(0xCD5003B097200F36, ped, p1, p2); } // 0xCD5003B097200F36 0x129F9DC1
	...
	static Vect3 GET_ANIM_INITIAL_OFFSET_POSITION(char* animDict, char* animName, float x, float y, float z, float xRot, float yRot, float zRot, float p8, int p9) { return invoke<Vect3>(0xBE22B26DD764C040, animDict, animName, x, y, z, xRot, yRot, zRot, p8, p9); } // 0xBE22B26DD764C040 0xC59D4268
	static Vect3 GET_ANIM_INITIAL_OFFSET_ROTATION(char* animDict, char* animName, float x, float y, float z, float xRot, float yRot, float zRot, float p8, int p9) { return invoke<Vect3>(0x4B805E6046EE9E47, animDict, animName, x, y, z, xRot, yRot, zRot, p8, p9); } // 0x4B805E6046EE9E47 0x5F7789E6
	...
	static Vect3 GET_PED_DEFENSIVE_AREA_POSITION(Ped ped, BOOL p1) { return invoke<Vect3>(0x3C06B8786DD94CD1, ped, p1); } // 0x3C06B8786DD94CD1 0xCB65198D
	...
	static Vect3 GET_PED_EXTRACTED_DISPLACEMENT(Ped ped, BOOL worldSpace) { return invoke<Vect3>(0xE0AF41401ADF87E3, ped, worldSpace); } // 0xE0AF41401ADF87E3 0x5231F901
	...
	static Vect3 GET_PED_BONE_COORDS(Ped ped, int boneId, float offsetX, float offsetY, float offsetZ) { return invoke<Vect3>(0x17C07FC640E86B4E, ped, boneId, offsetX, offsetY, offsetZ); } // 0x17C07FC640E86B4E 0x4579CAB1
...
namespace VEHICLE
{
	...
	static Vect3 _0x92523B76657A517D(Any p0, float p1) { return invoke<Vect3>(0x92523B76657A517D, p0, p1); } // 0x92523B76657A517D 0xF31973BB
	static Vect3 GET_POSITION_OF_VEHICLE_RECORDING_AT_TIME(int p0, float p1, char* p2) { return invoke<Vect3>(0xD242728AA6F0FBA2, p0, p1, p2); } // 0xD242728AA6F0FBA2 0x7178558D
	static Vect3 _0xF0F2103EFAF8CBA7(Any p0, float p1) { return invoke<Vect3>(0xF0F2103EFAF8CBA7, p0, p1); } // 0xF0F2103EFAF8CBA7 0x4D1C15C2
	static Vect3 GET_ROTATION_OF_VEHICLE_RECORDING_AT_TIME(Any p0, float p1, Any* p2) { return invoke<Vect3>(0x2058206FBE79A8AD, p0, p1, p2); } // 0x2058206FBE79A8AD 0xD96DEC68
	...
	static Vect3 GET_VEHICLE_DEFORMATION_AT_POS(Vehicle vehicle, float offsetX, float offsetY, float offsetZ) { return invoke<Vect3>(0x4EC6CFBC7B2E9536, vehicle, offsetX, offsetY, offsetZ); } // 0x4EC6CFBC7B2E9536 0xABF02075
	...
	static BOOL _0xA4822F1CF23F4810(Vect3* outVec, Any p1, Vect3* outVec1, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { return invoke<BOOL>(0xA4822F1CF23F4810, outVec, p1, outVec1, p3, p4, p5, p6, p7, p8); } // 0xA4822F1CF23F4810 0x34E02FCD
	...
	static Vect3 _GET_CARGOBOB_HOOK_POSITION(Vehicle cargobob) { return invoke<Vect3>(0xCBDB9B923CACC92D, cargobob); } // 0xCBDB9B923CACC92D
	...
	static void _0xDF7E3EEB29642C38(Vehicle vehicle, Vect3* out1, Vect3* out2) { invoke<Void>(0xDF7E3EEB29642C38, vehicle, out1, out2); } // 0xDF7E3EEB29642C38
...
namespace OBJECT
{
	...
	static Vect3 _GET_OBJECT_OFFSET_FROM_COORDS(float xPos, float yPos, float zPos, float heading, float xOffset, float yOffset, float zOffset) { return invoke<Vect3>(0x163E252DE035A133, xPos, yPos, zPos, heading, xOffset, yOffset, zOffset); } // 0x163E252DE035A133 0x87A42A12
	static Any _0x163F8B586BC95F2A(Any coords, float radius, Hash modelHash, float x, float y, float z, Vect3* p6, int p7) { return invoke<Any>(0x163F8B586BC95F2A, coords, radius, modelHash, x, y, z, p6, p7); } // 0x163F8B586BC95F2A 0x65213FC3
	...
	static Vect3 GET_SAFE_PICKUP_COORDS(float x, float y, float z, Any p3, Any p4) { return invoke<Vect3>(0x6E16BC2503FF1FF0, x, y, z, p3, p4); } // 0x6E16BC2503FF1FF0 0x618B5F67
	static Vect3 GET_PICKUP_COORDS(Pickup pickup) { return invoke<Vect3>(0x225B8B35C88029B3, pickup); } // 0x225B8B35C88029B3 0xC2E1E2C5
...
namespace AI
{
	...
	static Vect3 GET_SCRIPTED_COVER_POINT_COORDS(ScrHandle coverpoint) { return invoke<Vect3>(0x594A1028FC2A3E85, coverpoint); } // 0x594A1028FC2A3E85 0xC6B6CCC1
	...
	static BOOL WAYPOINT_RECORDING_GET_COORD(char* name, int point, Vect3* coord) { return invoke<BOOL>(0x2FB897405C90B361, name, point, coord); } // 0x2FB897405C90B361 0x19266913
...
namespace GAMEPLAY
{
	...
	static Vect3 GET_WIND_DIRECTION() { return invoke<Vect3>(0x1F400FEF721170DA); } // 0x1F400FEF721170DA 0x89499A0D
	...
	static BOOL _GET_GROUND_Z_COORD_WITH_OFFSETS(float x, float y, float z, float* groundZ, Vect3* offsets) { return invoke<BOOL>(0x8BDC7BFC57A81E76, x, y, z, groundZ, offsets); } // 0x8BDC7BFC57A81E76 0x64D91CED
	...
	static Vect3 _0x21C235BC64831E5A(float p0, float p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8, BOOL p9) { return invoke<Vect3>(0x21C235BC64831E5A, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0x21C235BC64831E5A 0xCAECF37E
	...
	static void GET_MODEL_DIMENSIONS(Hash modelHash, Vect3* minimum, Vect3* maximum) { invoke<Void>(0x03E8D3D5F549087A, modelHash, minimum, maximum); } // 0x03E8D3D5F549087A 0x91ABB8E0
	...
	static BOOL _GET_IS_PROJECTILE_TYPE_IN_AREA(float x1, float y1, float z1, float x2, float y2, float z2, Hash projHash, Vect3* projPos, BOOL ownedByPlayer) { return invoke<BOOL>(0x8D7A43EC6A5FEA45, x1, y1, z1, x2, y2, z2, projHash, projPos, ownedByPlayer); } // 0x8D7A43EC6A5FEA45 0x1A40454B
	static BOOL _GET_PROJECTILE_NEAR_PED_COORDS(Ped ped, Hash projHash, float radius, Vect3* projPos, BOOL ownedByPlayer) { return invoke<BOOL>(0xDFB4138EEFED7B81, ped, projHash, radius, projPos, ownedByPlayer); } // 0xDFB4138EEFED7B81 0x6BDE5CE4
	static BOOL _GET_PROJECTILE_NEAR_PED(Ped ped, Hash projHash, float radius, Vect3* projPos, Entity* projEnt, BOOL ownedByPlayer) { return invoke<BOOL>(0x82FDE6A57EE4EE44, ped, projHash, radius, projPos, projEnt, ownedByPlayer); } // 0x82FDE6A57EE4EE44 0x507BC6F7
	...
	static BOOL FIND_SPAWN_POINT_IN_DIRECTION(float x1, float y1, float z1, float x2, float y2, float z2, float distance, Vect3* spawnPoint) { return invoke<BOOL>(0x6874E2190B0C1972, x1, y1, z1, x2, y2, z2, distance, spawnPoint); } // 0x6874E2190B0C1972 0x71AEFD77
...
namespace INTERIOR
{
	...
	static Vect3 GET_OFFSET_FROM_INTERIOR_IN_WORLD_COORDS(int interiorID, float x, float y, float z) { return invoke<Vect3>(0x9E3B3E6D66F6E22F, interiorID, x, y, z); } // 0x9E3B3E6D66F6E22F 0x7D8F26A1
...
namespace CAM
{
	...
	static Vect3 GET_CAM_COORD(Cam cam) { return invoke<Vect3>(0xBAC038F7459AE5AE, cam); } // 0xBAC038F7459AE5AE 0x7C40F09C
	static Vect3 GET_CAM_ROT(Cam cam, int rotationOrder) { return invoke<Vect3>(0x7D304C1C955E3E12, cam, rotationOrder); } // 0x7D304C1C955E3E12 0xDAC84C9F
	...
	static Vect3 GET_GAMEPLAY_CAM_COORD() { return invoke<Vect3>(0x14D6F5678D8F1B37); } // 0x14D6F5678D8F1B37 0x9388CF79
	static Vect3 GET_GAMEPLAY_CAM_ROT(int rotationOrder) { return invoke<Vect3>(0x837765A25378F0BB, rotationOrder); } // 0x837765A25378F0BB 0x13A010B5
	...
	static Vect3 _GET_GAMEPLAY_CAM_COORDS() { return invoke<Vect3>(0xA200EB1EE790F448); } // 0xA200EB1EE790F448 0x9C84BDA0
	static Vect3 _GET_GAMEPLAY_CAM_ROT(int rotationOrder) { return invoke<Vect3>(0x5B4E4C817FCC2DFB, rotationOrder); } // 0x5B4E4C817FCC2DFB 0x1FFBEFC5
	static Vect3 _0x26903D9CD1175F2C(Any p0, Any p1) { return invoke<Vect3>(0x26903D9CD1175F2C, p0, p1); } // 0x26903D9CD1175F2C 0xACADF916
...
namespace WEAPON
{
	...
	static bool GET_PED_LAST_WEAPON_IMPACT_COORD(Ped ped, float* coords) { return invoke<bool>(0x6C4D0409BA1A2BC2, ped, coords); } // 0x6C4D0409BA1A2BC2 0x9B266079
...
namespace STREAMING
{
	...
	static Vect3* NETWORK_UPDATE_LOAD_SCENE() { return invoke<Vect3*>(0xC4582015556D1C46); } // 0xC4582015556D1C46 0xC76E023C
...
namespace UI
{
	...
	static Vect3 GET_BLIP_INFO_ID_COORD(Blip blip) { return invoke<Vect3>(0xFA7C7F0AADF25D09, blip); } // 0xFA7C7F0AADF25D09 0xB7374A66
	...
	static Vect3 GET_BLIP_COORDS(Blip blip) { return invoke<Vect3>(0x586AFE3FF72D996E, blip); } // 0x586AFE3FF72D996E 0xEF6FF47B
	...
	static Vect3 GET_HUD_COMPONENT_POSITION(int id) { return invoke<Vect3>(0x223CA69A8C4417FD, id); } // 0x223CA69A8C4417FD 0x080DCED6
	...
	static Vect3 _0x5BFF36D6ED83E0AE() { return invoke<Vect3>(0x5BFF36D6ED83E0AE); } // 0x5BFF36D6ED83E0AE
...
namespace GRAPHICS
{
	...
	static Vect3 GET_TEXTURE_RESOLUTION(char* textureDict, char* textureName) { return invoke<Vect3>(0x35736EE65BD00C11, textureDict, textureName); } // 0x35736EE65BD00C11 0x096DAA4D
	...
	static Vect3 _0xA4664972A9B8F8BA(Any p0) { return invoke<Vect3>(0xA4664972A9B8F8BA, p0); } // 0xA4664972A9B8F8BA 0xECD470F0
...
namespace MOBILE
{
	...
	static void GET_MOBILE_PHONE_ROTATION(Vect3* rotation, Vehicle p1) { invoke<Void>(0x1CEFB61F193070AE, rotation, p1); } // 0x1CEFB61F193070AE 0x17A29F23
	...
	static void GET_MOBILE_PHONE_POSITION(Vect3* position) { invoke<Void>(0x584FDFDA48805B86, position); } // 0x584FDFDA48805B86 0xB2E1E1A0
...
namespace PATHFIND
{
	...
	static BOOL GET_SAFE_COORD_FOR_PED(float x, float y, float z, BOOL onGround, Vect3* outPosition, int flags) { return invoke<BOOL>(0xB61C8E878A4199CA, x, y, z, onGround, outPosition, flags); } // 0xB61C8E878A4199CA 0xB370270A
	static BOOL GET_CLOSEST_VEHICLE_NODE(float x, float y, float z, Vect3* outPosition, int nodeType, float p5, float p6) { return invoke<BOOL>(0x240A18690AE96513, x, y, z, outPosition, nodeType, p5, p6); } // 0x240A18690AE96513 0x6F5F1E6C
	static BOOL GET_CLOSEST_MAJOR_VEHICLE_NODE(float x, float y, float z, Vect3* outPosition, float unknown1, int unknown2) { return invoke<BOOL>(0x2EABE3B06F58C1BE, x, y, z, outPosition, unknown1, unknown2); } // 0x2EABE3B06F58C1BE 0x04B5F15B
	static BOOL GET_CLOSEST_VEHICLE_NODE_WITH_HEADING(float x, float y, float z, Vect3* outPosition, float* outHeading, int nodeType, float p6, int p7) { return invoke<BOOL>(0xFF071FB798B803B0, x, y, z, outPosition, outHeading, nodeType, p6, p7); } // 0xFF071FB798B803B0 0x8BD5759B
	static BOOL GET_NTH_CLOSEST_VEHICLE_NODE(float x, float y, float z, int nthClosest, Vect3* outPosition, Any unknown1, Any unknown2, Any unknown3) { return invoke<BOOL>(0xE50E52416CCF948B, x, y, z, nthClosest, outPosition, unknown1, unknown2, unknown3); } // 0xE50E52416CCF948B 0xF125BFCC
	...
	static BOOL GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(float x, float y, float z, int nthClosest, Vect3* outPosition, float* heading, Any* unknown1, int unknown2, float unknown3, float unknown4) { return invoke<BOOL>(0x80CA6A8B6C094CC4, x, y, z, nthClosest, outPosition, heading, unknown1, unknown2, unknown3, unknown4); } // 0x80CA6A8B6C094CC4 0x7349C856
	static Any GET_NTH_CLOSEST_VEHICLE_NODE_ID_WITH_HEADING(float x, float y, float z, int nthClosest, Vect3* outPosition, float outHeading, Any p6, float p7, float p8) { return invoke<Any>(0x6448050E9C2A7207, x, y, z, nthClosest, outPosition, outHeading, p6, p7, p8); } // 0x6448050E9C2A7207 0xC1AEB88D
	static BOOL GET_NTH_CLOSEST_VEHICLE_NODE_FAVOUR_DIRECTION(float x, float y, float z, float desiredX, float desiredY, float desiredZ, int nthClosest, Vect3* outPosition, float* outHeading, int nodetype, Any p10, Any p11) { return invoke<BOOL>(0x45905BE8654AE067, x, y, z, desiredX, desiredY, desiredZ, nthClosest, outPosition, outHeading, nodetype, p10, p11); } // 0x45905BE8654AE067 0x928A4DEC
	...
	static void GET_VEHICLE_NODE_POSITION(int nodeId, Vect3* outPosition) { invoke<Void>(0x703123E5E7D429C2, nodeId, outPosition); } // 0x703123E5E7D429C2 0xE38E252D
	...
	static Any GET_CLOSEST_ROAD(float x, float y, float z, float p3, int p4, Vect3* p5, Vect3* p6, Any* p7, Any* p8, float* p9, BOOL p10) { return invoke<Any>(0x132F52BBA570FE92, x, y, z, p3, p4, p5, p6, p7, p8, p9, p10); } // 0x132F52BBA570FE92 0x567B0E11
	...
	static BOOL GET_RANDOM_VEHICLE_NODE(float x, float y, float z, float radius, BOOL p4, BOOL p5, BOOL p6, Vect3* outPosition, int* nodeId) { return invoke<BOOL>(0x93E0DB8440B73A7D, x, y, z, radius, p4, p5, p6, outPosition, nodeId); } // 0x93E0DB8440B73A7D 0xAD1476EA
...
namespace CONTROLS
{
	...
	static void DISABLE_CONTROL_ACTION(int inputGroup, int control) { invoke<Void>(0xFE99B66D079CF6BC, inputGroup, control); } // 0xFE99B66D079CF6BC 0x3800C0DC
...
namespace DATAFILE
{
	...
	static Vect3 _OBJECT_VALUE_GET_VECTOR3(Any* objectData, char* key) { return invoke<Vect3>(0x46CD3CB66E0825CC, objectData, key); } // 0x46CD3CB66E0825CC 0xE84A127A
	...
	static Vect3 _ARRAY_VALUE_GET_VECTOR3(Any* arrayData, int arrayIndex) { return invoke<Vect3>(0x8D2064E5B64A628A, arrayData, arrayIndex); } // 0x8D2064E5B64A628A 0x80E3DA55
...
namespace FIRE
{
	...
	static BOOL GET_CLOSEST_FIRE_POS(Vect3* outPosition, float x, float y, float z) { return invoke<BOOL>(0x352A9F6BCF90081F, outPosition, x, y, z); } // 0x352A9F6BCF90081F 0xC4977B47
...
namespace ROPE
{
	...
	static Vect3 GET_ROPE_LAST_VERTEX_COORD(Object rope) { return invoke<Vect3>(0x21BB0FBD3E217C2D, rope); } // 0x21BB0FBD3E217C2D 0x91F6848B
	static Vect3 GET_ROPE_VERTEX_COORD(Object rope, int vertex) { return invoke<Vect3>(0xEA61CA8E80F09E4D, rope, vertex); } // 0xEA61CA8E80F09E4D 0x84374452
	...
	static Vect3 GET_CGOFFSET(Object rope) { return invoke<Vect3>(0x8214A4B5A7A33612, rope); } // 0x8214A4B5A7A33612 0x49A11F0D
...
namespace WATER
{
	...
	static BOOL TEST_PROBE_AGAINST_WATER(float x1, float y1, float z1, float x2, float y2, float z2, Vect3* result) { return invoke<BOOL>(0xFFA5D878809819DB, x1, y1, z1, x2, y2, z2, result); } // 0xFFA5D878809819DB 0xAA4AE00C
...
namespace WORLDPROBE
{
	...
	static int _START_SHAPE_TEST_SURROUNDING_COORDS(Vect3* pVec1, Vect3* pVec2, int flag, Entity entity, int flag2) { return invoke<int>(0xFF6BE494C7987F34, pVec1, pVec2, flag, entity, flag2); } // 0xFF6BE494C7987F34
	static int GET_SHAPE_TEST_RESULT(int rayHandle, BOOL* hit, Vect3* endCoords, Vect3* surfaceNormal, Entity* entityHit) { return invoke<int>(0x3D87450E15D98694, rayHandle, hit, endCoords, surfaceNormal, entityHit); } // 0x3D87450E15D98694 0xF3C2875A
	static int _GET_SHAPE_TEST_RESULT_EX(int rayHandle, BOOL* hit, Vect3* endCoords, Vect3* surfaceNormal, Hash* materialHash, Entity* entityHit) { return invoke<int>(0x65287525D951F6BE, rayHandle, hit, endCoords, surfaceNormal, materialHash, entityHit); } // 0x65287525D951F6BE 0x4301E10C
...
namespace NETWORK
{
	...
	static void NETWORK_GET_RESPAWN_RESULT(int randomInt, Vect3* coordinates, float* heading) { invoke<Void>(0x371EA43692861CF1, randomInt, coordinates, heading); } // 0x371EA43692861CF1 0xDDFE9FBC
	...
	static BOOL _0xC22912B1D85F26B1(int p0, int* p1, Vect3* p2) { return invoke<BOOL>(0xC22912B1D85F26B1, p0, p1, p2); } // 0xC22912B1D85F26B1 0x8570DD34
